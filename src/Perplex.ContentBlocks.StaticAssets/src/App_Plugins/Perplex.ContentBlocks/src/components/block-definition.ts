import {html, customElement, property, nothing, css, styleMap, state} from "@umbraco-cms/backoffice/external/lit";
...
export class PcbBlockDefinition extends LitElement {
    ...
    onSelected() {
        ...
        this.dispatchEvent(new CustomEvent(ON_BLOCK_SELECTED, {
            bubbles: true,
            detail: {
                id: UmbId.new(),
