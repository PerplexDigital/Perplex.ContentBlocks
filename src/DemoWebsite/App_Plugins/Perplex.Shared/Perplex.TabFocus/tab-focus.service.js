angular.module("umbraco").service("tabFocusService", [
    ...
    function ($rootScope, $timeout) {
        ...
        // Data attribute used to attach a unique id to a DOM element.
        var elementIdAttr = "data-tab-focus-id";
         ...
         * provided callback function when it becomes active.
         * @param {Element} tab The Content App to observe
         ...
         * @param {Element} element The element to get the id of
         * @returns {string}
         */
        function getElementId(element) {
            ...
            var id = element.getAttribute(elementIdAttr);
        ...
        function setElementId(element) {
            element.setAttribute(elementIdAttr, nextId);
            return nextId++;
        }
