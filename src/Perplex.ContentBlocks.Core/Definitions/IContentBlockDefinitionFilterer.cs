...
public interface IContentBlockDefinitionFilterer
{
    ...
    IEnumerable<IContentBlockDefinition> FilterForCultureAndDocumentType(IEnumerable<IContentBlockDefinition> definitions, string culture, string documentType);
